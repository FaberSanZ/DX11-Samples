...
internal sealed class RenderSystem : IDisposable
{
    ...
    private void CreateDepthBuffer()
    {
        ...
        _depthStencilView = _device.CreateDepthStencilView(
            _depthStencilBuffer,
            new DepthStencilViewDescription(_depthStencilBuffer, DepthStencilViewDimension.Texture2D)
        );
    ...
    public void UpdateCamera()
    {
        ...
        Matrix4x4 world = Matrix4x4.CreateFromYawPitchRoll(
            _cubeRotation,
            _cubeRotation,
            _cubeRotation
        );
...
internal static class Program
{
    public static void Main()
    {
        ...
        {
            Title = "DX11 ConstantBuffers Camera",
            Width = 1200,
            Height = 820,
            Resizable = true
        });
